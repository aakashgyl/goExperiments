...
var testParams = map[string]string{
	"boundary": "--==8xd/xHtnRl8hvOUnbY3Q2fd03Mxh1kX96XGRiZoLLLEM8QeeDLJdTzXtJU9n==",
	"start":    "<SOAP-ENV:Envelope>",
	"type":     "text/xml",
}

func main() {
	cidPartMap := make(map[string]string)

	//	respHeader := mimeResp.Header["Content-Type"][0]
	mediaType, headerParams, _ := mime.ParseMediaType(testHead2)
	_ = headerParams["start"]
	fmt.Println(headerParams)
	if strings.HasPrefix(mediaType, "multipart") {
		//		respBody, _ := ioutil.ReadAll(mimeResp.Body)
		respBodyReader := strings.NewReader(testBody5)
		partReader := multipart.NewReader(respBodyReader, headerParams["boundary"])

		for {
			fmt.Println("Get new one...")
			...
			if err != nil {
				fmt.Println("Error while parsing multipart", err)
			}
			fmt.Println("Lets read...")
			partBody, _ := ioutil.ReadAll(part)
			fmt.Println("Lets insert...")
			cidPartMap[part.Header.Get("Content-ID")] = string(partBody)
			fmt.Println("Lets move on...")
		}
	}
//	fmt.Println(cidPartMap, start)
}

var testHead = `multipart/related; charset=utf-8; boundary="==NYWcypeWQfeVATnTH6W/1hXV7Yh15qygqIEv29mNaHpM7Dd7SLbqzBzS7H15=="; type="text/xml"; start="getFeedback"`

var testHead2 = `multipart/related; charset=utf-8; boundary="==NdasSE2dBYOzlEPEFkEkcXSQAa738auv/CN2KEZ1CBsvPnuJJiuvDvo2Fcmi=="; type="text/xml"; start="<SOAP-ENV:Envelope>"`
var testBody5 = `--==NdasSE2dBYOzlEPEFkEkcXSQAa738auv/CN2KEZ1CBsvPnuJJiuvDvo2Fcmi==
Content-Type: text/xml; charset=utf-8
Content-Transfer-Encoding: binary
Content-ID: <SOAP-ENV:Envelope>

<?xml version="1.0" encoding="UTF-8"?>
<SOAP-ENV:Envelope xmlns:SOAP-ENV="http://schemas.xmlsoap.org/soap/envelope/" xmlns:SOAP-ENC="http://schemas.xmlsoap.org/soap/encoding/" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:ne3scommon="http://www.nokiasiemens.com/ne3s/1.0"><SOAP-ENV:Header></SOAP-ENV:Header><SOAP-ENV:Body><ne3scommon:getResponse><ne3scommon:agentRegistrationId>123456</ne3scommon:agentRegistrationId><ne3scommon:agentRegistrationKey>hqArP+FxYI3mUdSufxxyArOwOQBSR8DfyMzedPBBZnqkoLfd3DhtyOAxCwKX66q5HFP9BTo8YU0W8f9H8faXuw==</ne3scommon:agentRegistrationKey><ne3scommon:attachmentProperties><ne3scommon:compression>none</ne3scommon:compression><ne3scommon:contentType>ocos</ne3scommon:contentType><ne3scommon:checksum><ne3scommon:algorithm>none</ne3scommon:algorithm></ne3scommon:checksum></ne3scommon:attachmentProperties><ne3scommon:getResponseContent>cid:getContent</ne3scommon:getResponseContent><ne3scommon:getResponseFeedback>cid:getFeedback</ne3scommon:getResponseFeedback></ne3scommon:getResponse></SOAP-ENV:Body></SOAP-ENV:Envelope>

--==NdasSE2dBYOzlEPEFkEkcXSQAa738auv/CN2KEZ1CBsvPnuJJiuvDvo2Fcmi==
...
<raml version="2.1" xmlns="raml21.xsd">
 <cmData type="plan" scope="all" id="">
  <header>
   <log action = "get" dateTime="2004-01-01T05:31:51+05:30"></log>
  </header>
  <managedObject class="NOKLTE:ACBPR" version="FLF18SP_1712_02_1711_04" distName="MRBTS-1/LNBTS-1/ACBPR-0" operation="create">
   <p name="eCallAcBarredStatic">Not barred</p>
  </managedObject>
  <managedObject class="NOKLTE:AMGR" version="FLF18SP_1712_02_1711_04" distName="MRBTS-1/LNBTS-1/FTM-1/AMGR-1" operation="create">
  ...
  <managedObject class="NOKLTE:ANR" version="FLF18SP_1712_02_1711_04" distName="MRBTS-1/LNBTS-1/ANR-0" operation="create">
  ...
  <managedObject class="NOKLTE:ANRPRL" version="FLF18SP_1712_02_1711_04" distName="MRBTS-1/LNBTS-1/ANRPRL-0" operation="create">
  ...
  <managedObject class="com.nokia.srbts.eqm:ANTL" version="EQM18SP_FZM_1712_002" distName="MRBTS-1/EQM-1/APEQM-1/RMOD-1/ANTL-1" operation="create">
   <p name="antennaRoundTripDelay">45</p>
  </managedObject>
  <managedObject class="com.nokia.srbts.eqm:ANTL" version="EQM18SP_FZM_1712_002" distName="MRBTS-1/EQM-1/APEQM-1/RMOD-1/ANTL-2" operation="create">
   <p name="antennaRoundTripDelay">45</p>
  </managedObject>
  <managedObject class="com.nokia.srbts.eqmr:ANTL_R" version="EQMR18SP_FZM_1712_002" distName="MRBTS-1/EQM_R-1/APEQM_R-1/RMOD_R-1/ANTL_R-1" operation="create">
   <p name="configDN">MRBTS-1/EQM-1/APEQM-1/RMOD-1/ANTL-1</p>
  </managedObject>
  <managedObject class="com.nokia.srbts.eqmr:ANTL_R" version="EQMR18SP_FZM_1712_002" distName="MRBTS-1/EQM_R-1/APEQM_R-1/RMOD_R-1/ANTL_R-2" operation="create">
   <p name="configDN">MRBTS-1/EQM-1/APEQM-1/RMOD-1/ANTL-2</p>
  </managedObject>
  <managedObject class="com.nokia.srbts.eqm:APEQM" version="EQM18SP_FZM_1712_002" distName="MRBTS-1/EQM-1/APEQM-1" operation="create">
  </managedObject>
  <managedObject class="com.nokia.srbts.eqmr:APEQM_R" version="EQMR18SP_FZM_1712_002" distName="MRBTS-1/EQM_R-1/APEQM_R-1" operation="create">
  </managedObject>
  <managedObject class="NOKLTE:BFDGRP" version="FLF18SP_1712_02_1711_04" distName="MRBTS-1/LNBTS-1/FTM-1/IPNO-1/BFDGRP-8" operation="create">
  </managedObject>
  <managedObject class="NOKLTE:BFDGRP" version="FLF18SP_1712_02_1711_04" distName="MRBTS-1/LNBTS-1/FTM-1/IPNO-1/BFDGRP-7" operation="create">
  </managedObject>
  <managedObject class="NOKLTE:BFDGRP" version="FLF18SP_1712_02_1711_04" distName="MRBTS-1/LNBTS-1/FTM-1/IPNO-1/BFDGRP-6" operation="create">
  </managedObject>
  <managedObject class="NOKLTE:BFDGRP" version="FLF18SP_1712_02_1711_04" distName="MRBTS-1/LNBTS-1/FTM-1/IPNO-1/BFDGRP-5" operation="create">
  </managedObject>
  <managedObject class="NOKLTE:BFDGRP" version="FLF18SP_1712_02_1711_04" distName="MRBTS-1/LNBTS-1/FTM-1/IPNO-1/BFDGRP-4" operation="create">
  </managedObject>
  <managedObject class="NOKLTE:BFDGRP" version="FLF18SP_1712_02_1711_04" distName="MRBTS-1/LNBTS-1/FTM-1/IPNO-1/BFDGRP-1" operation="create">
  </managedObject>
  <managedObject class="NOKLTE:BFDGRP" version="FLF18SP_1712_02_1711_04" distName="MRBTS-1/LNBTS-1/FTM-1/IPNO-1/BFDGRP-2" operation="create">
  </managedObject>
  <managedObject class="NOKLTE:BFDGRP" version="FLF18SP_1712_02_1711_04" distName="MRBTS-1/LNBTS-1/FTM-1/IPNO-1/BFDGRP-3" operation="create">
  </managedObject>
  <managedObject class="NOKLTE:BTOOTH" version="FLF18SP_1712_02_1711_04" distName="MRBTS-1/LNBTS-1/FTM-1/BTOOTH-1" operation="create">
  ...
  <managedObject class="com.nokia.srbts.eqm:CABINET" version="EQM18SP_FZM_1712_002" distName="MRBTS-1/EQM-1/APEQM-1/CABINET-1" operation="create">
  </managedObject>
  <managedObject class="com.nokia.srbts.eqmr:CABINET_R" version="EQMR18SP_FZM_1712_002" distName="MRBTS-1/EQM_R-1/APEQM_R-1/CABINET_R-1" operation="create">
  </managedObject>
  <managedObject class="com.nokia.srbts.mnl:CELLMAPPING" version="MNL18SP_FZM_1712_002" distName="MRBTS-1/MNL-1/MNLENT-1/CELLMAPPING-1" operation="create">
  </managedObject>
  <managedObject class="NOKLTE:CERTH" version="FLF18SP_1712_02_1711_04" distName="MRBTS-1/LNBTS-1/FTM-1/CERTH-1" operation="create">
  ...
  <managedObject class="com.nokia.srbts.mnl:CHANNEL" version="MNL18SP_FZM_1712_002" distName="MRBTS-1/MNL-1/MNLENT-1/CELLMAPPING-1/LCELL-1/CHANNELGROUP-1/CHANNEL-1" operation="create">
   <p name="antlDN">MRBTS-1/EQM-1/APEQM-1/RMOD-1/ANTL-1</p>
   <p name="direction">TX</p>
  </managedObject>
  <managedObject class="com.nokia.srbts.mnl:CHANNEL" version="MNL18SP_FZM_1712_002" distName="MRBTS-1/MNL-1/MNLENT-1/CELLMAPPING-1/LCELL-1/CHANNELGROUP-1/CHANNEL-2" operation="create">
   <p name="antlDN">MRBTS-1/EQM-1/APEQM-1/RMOD-1/ANTL-2</p>
   <p name="direction">TX</p>
  </managedObject>
  <managedObject class="com.nokia.srbts.mnl:CHANNEL" version="MNL18SP_FZM_1712_002" distName="MRBTS-1/MNL-1/MNLENT-1/CELLMAPPING-1/LCELL-1/CHANNELGROUP-1/CHANNEL-3" operation="create">
   <p name="antlDN">MRBTS-1/EQM-1/APEQM-1/RMOD-1/ANTL-1</p>
   <p name="direction">RX</p>
  </managedObject>
  <managedObject class="com.nokia.srbts.mnl:CHANNEL" version="MNL18SP_FZM_1712_002" distName="MRBTS-1/MNL-1/MNLENT-1/CELLMAPPING-1/LCELL-1/CHANNELGROUP-1/CHANNEL-4" operation="create">
   <p name="antlDN">MRBTS-1/EQM-1/APEQM-1/RMOD-1/ANTL-2</p>
   <p name="direction">RX</p>
  </managedObject>
  <managedObject class="com.nokia.srbts.mnl:CHANNELGROUP" version="MNL18SP_FZM_1712_002" distName="MRBTS-1/MNL-1/MNLENT-1/CELLMAPPING-1/LCELL-1/CHANNELGROUP-1" operation="create">
  </managedObject>
  <managedObject class="com.nokia.srbts.mnl:CLOCK" version="MNL18SP_FZM_1712_002" distName="MRBTS-1/MNL-1/MNLENT-1/SYNC-1/CLOCK-1" operation="create">
  ...
  <managedObject class="com.nokia.srbts.mnl:CLOCK_R" version="MNL18SP_FZM_1712_002" distName="MRBTS-1/MNL-1/MNLENT-1/SYNC-1/CLOCK-1/CLOCK_R-1" operation="create">
   <p name="activeSyncMode">FreqSync</p>
  </managedObject>
  <managedObject class="com.nokia.srbts.mnl:CMD" version="MNL18SP_FZM_1712_002" distName="MRBTS-1/MNL-1/CMD-1" operation="create">
  </managedObject>
  <managedObject class="NOKLTE:DRX" version="FLF18SP_1712_02_1711_04" distName="MRBTS-1/LNBTS-1/LNCEL-0/DRX-0" operation="create">
  ...
  <managedObject class="com.nokia.srbts.eqm:EQM" version="EQM18SP_FZM_1712_002" distName="MRBTS-1/EQM-1" operation="create">
  </managedObject>
  <managedObject class="com.nokia.srbts.eqmr:EQM_R" version="EQMR18SP_FZM_1712_002" distName="MRBTS-1/EQM_R-1" operation="create">
  </managedObject>
  <managedObject class="NOKLTE:ETHLK" version="FLF18SP_1712_02_1711_04" distName="MRBTS-1/LNBTS-1/FTM-1/ETHLK-1-1" operation="create">
  ...
  <managedObject class="NOKLTE:ETHLK" version="FLF18SP_1712_02_1711_04" distName="MRBTS-1/LNBTS-1/FTM-1/ETHLK-1-2" operation="create">
   <list name = "l2VlanIdList">
   </list>
   <p name="acceptableFrameTypes">ADMIT_ALL</p>
   <p name="administrativeState">unlocked</p>
  ...
  <managedObject class="com.nokia.srbts.mnl:FEATCADM" version="MNL18SP_FZM_1712_002" distName="MRBTS-1/MNL-1/MNLENT-1/FEATCADM-1" operation="create">
  ...
  <managedObject class="com.nokia.srbts.mnl:FMCADM" version="MNL18SP_FZM_1712_002" distName="MRBTS-1/MNL-1/MNLENT-1/FMCADM-1" operation="create">
   <p name="actCategoryAlarms">false</p>
  </managedObject>
  <managedObject class="NOKLTE:FTM" version="FLF18SP_1712_02_1711_04" distName="MRBTS-1/LNBTS-1/FTM-1" operation="create">
   ...
   <p name="softwareReleaseVersion">FTM_L18SP_SR18SP_W19_G19_2018.01.16_0122</p>
   <p name="systemTitle">FZM_GMC</p>
   <p name="userLabel"></p>
  </managedObject>
  <managedObject class="com.nokia.srbts.mnl:GNSSI" version="MNL18SP_FZM_1712_002" distName="MRBTS-1/MNL-1/MNLENT-1/SYNC-1/CLOCK-1/GNSSI-1" operation="create">
   <p name="actGnssOutputLnaPowerSupply">false</p>
   <p name="gnssControlMode">GPS-GLONASS</p>
   <p name="locationMode">automatic</p>
  </managedObject>
  <managedObject class="com.nokia.srbts.eqmr:GNSSI_R" version="EQMR18SP_FZM_1712_002" distName="MRBTS-1/EQM_R-1/APEQM_R-1/CABINET_R-1/SMOD_R-1/GNSSI_R-1" operation="create">
  ...
  <managedObject class="NOKLTE:GTPU" version="FLF18SP_1712_02_1711_04" distName="MRBTS-1/LNBTS-1/GTPU-1" operation="create">
   <list name = "sgwIpAddressList">
    <item>
   <p name="sgwIpAddress">172.23.2.50</p>
  ...
  <managedObject class="NOKLTE:IDNS" version="FLF18SP_1712_02_1711_04" distName="MRBTS-1/LNBTS-1/FTM-1/IPNO-1/IDNS-1" operation="create">
   <p name="serverIpAddress">0.0.0.0</p>
   <p name="serverIpAddress2">0.0.0.0</p>
  </managedObject>
  <managedObject class="NOKLTE:IEIF" version="FLF18SP_1712_02_1711_04" distName="MRBTS-1/LNBTS-1/FTM-1/IPNO-1/IEIF-1" operation="create">
   <p name="localIpAddr">0.0.0.0</p>
  ...
  <managedObject class="NOKLTE:INTP" version="FLF18SP_1712_02_1711_04" distName="MRBTS-1/LNBTS-1/FTM-1/IPNO-1/INTP-1" operation="create">
   <list name = "ntpServers">
   <p>138.203.19.128</p>
   </list>
   <p name="maxNtpTimeError">1500</p>
   <p name="ntpDscp">46</p>
   <p name="ntpSourceIpAddress">0.0.0.0</p>
  ...
  <managedObject class="NOKLTE:IPNO" version="FLF18SP_1712_02_1711_04" distName="MRBTS-1/LNBTS-1/FTM-1/IPNO-1" operation="create">
   ...
   <p name="cPlaneIpAddress">172.23.2.113</p>
   ...
   <p name="mPlaneIpAddress">172.23.2.113</p>
   ...
   <p name="uPlaneIpAddress">172.23.2.113</p>
   <p name="uPlaneIpv6Address">::</p>
   <p name="wfqSchedOamWeight">10</p>
  </managedObject>
  <managedObject class="NOKLTE:IPRT" version="FLF18SP_1712_02_1711_04" distName="MRBTS-1/LNBTS-1/FTM-1/IPNO-1/IPRT-1" operation="create">
   <list name = "staticRoutes">
    <item>
   <p name="bfdId">0</p>
   <p name="destIpAddr">0.0.0.0</p>
   <p name="gateway">172.23.2.114</p>
   <p name="netmask">0.0.0.0</p>
  ...
  <managedObject class="NOKLTE:IPRTV6" version="FLF18SP_1712_02_1711_04" distName="MRBTS-1/LNBTS-1/FTM-1/IPNO-1/IPRTV6-1" operation="create">
   <list name = "staticIpv6Routes">
   </list>
  </managedObject>
  <managedObject class="NOKLTE:IPSECC" version="FLF18SP_1712_02_1711_04" distName="MRBTS-1/LNBTS-1/FTM-1/IPSECC-1" operation="create">
  ...
  <managedObject class="NOKLTE:IVIF" version="FLF18SP_1712_02_1711_04" distName="MRBTS-1/LNBTS-1/FTM-1/IPNO-1/IEIF-1/IVIF-1" operation="create">
   <p name="localIpAddr">172.23.2.113</p>
   <p name="localIpv6Addr">::</p>
   <p name="localIpv6PrefixLength">0</p>
  ...
  <managedObject class="NOKLTE:L2SWI" version="FLF18SP_1712_02_1711_04" distName="MRBTS-1/LNBTS-1/FTM-1/L2SWI-1" operation="create">
   <list name = "dscpMap">
    <item>
   <p name="dscp">0</p>
  ...
  <managedObject class="NOKLTE:LBPUCCHRDPR" version="FLF18SP_1712_02_1711_04" distName="MRBTS-1/LNBTS-1/LBPUCCHRDPR-0" operation="create">
  ...
  <managedObject class="com.nokia.srbts.mnl:LCELL" version="MNL18SP_FZM_1712_002" distName="MRBTS-1/MNL-1/MNLENT-1/CELLMAPPING-1/LCELL-1" operation="create">
  </managedObject>
  <managedObject class="NOKLTE:LNADJG" version="FLF18SP_1712_02_1711_04" distName="MRBTS-1/LNBTS-1/LNADJG-0" operation="create">
  ...
  <managedObject class="NOKLTE:LNBTS" version="FLF18SP_1712_02_1711_04" distName="MRBTS-1/LNBTS-1" operation="create">
   ...
   <p name="operationalState">commissioned</p>
   ...
   <p name="s1InducedCellDeactDelayTime">900</p>
  ...
  <managedObject class="NOKLTE:LNBTS_FDD" version="FLF18SP_1712_02_1711_04" distName="MRBTS-1/LNBTS-1/LNBTS_FDD-0" operation="create">
  ...
  <managedObject class="NOKLTE:LNCEL" version="FLF18SP_1712_02_1711_04" distName="MRBTS-1/LNBTS-1/LNCEL-0" operation="create">
   ...
   <p name="actEDrxIdleCatM">false</p>
   ...
   <p name="amlePeriodLoadExchange">1000ms</p>
   ...
   <p name="useT312">false</p>
  </managedObject>
  <managedObject class="NOKLTE:LNCEL_FDD" version="FLF18SP_1712_02_1711_04" distName="MRBTS-1/LNBTS-1/LNCEL-0/LNCEL_FDD-0" operation="create">
  ...
  <managedObject class="NOKLTE:LNHOIF" version="FLF18SP_1712_02_1711_04" distName="MRBTS-1/LNBTS-1/LNCEL-0/LNHOIF-1" operation="create">
  ...
  <managedObject class="NOKLTE:LNMME" version="FLF18SP_1712_02_1711_04" distName="MRBTS-1/LNBTS-1/LNMME-0" operation="create">
   ...
   <p name="administrativeState">unlocked</p>
   <p name="ipAddrPrim">172.23.2.50</p>
   <p name="mmeRatSupport">Wideband-LTE</p>
   <p name="transportNwId">0</p>
  </managedObject>
  <managedObject class="NOKLTE:LTAC" version="FLF18SP_1712_02_1711_04" distName="MRBTS-1/LNBTS-1/FTM-1/TAC-1/LTAC-1" operation="create">
  ...
  <managedObject class="NOKLTE:LUAC" version="FLF18SP_1712_02_1711_04" distName="MRBTS-1/LNBTS-1/FTM-1/AMGR-1/LUAC-1" operation="create">
  ...
  <managedObject class="com.nokia.srbts.mnl:MNL" version="MNL18SP_FZM_1712_002" distName="MRBTS-1/MNL-1" operation="create">
   <p name="productVariantPlanned">fzmBTS</p>
   <p name="validatePlanAgainstDetectedHW">false</p>
  </managedObject>
  <managedObject class="com.nokia.srbts.mnl:MNLENT" version="MNL18SP_FZM_1712_002" distName="MRBTS-1/MNL-1/MNLENT-1" operation="create">
  </managedObject>
  <managedObject class="com.nokia.srbts.mnl:MNL_R" version="MNL18SP_FZM_1712_002" distName="MRBTS-1/MNL-1/MNL_R-1" operation="create">
   <p name="activeSWActivationTime">2004-01-01T05:41:18.687+05:30</p>
   <p name="activeSWReleaseVersion">FLF18SP_ENB_9999_180116_000891</p>
   <p name="configDataRevisionNumber">200</p>
  </managedObject>
  <managedObject class="NOKLTE:MPUCCH_FDD" version="FLF18SP_1712_02_1711_04" distName="MRBTS-1/LNBTS-1/LNCEL-0/LNCEL_FDD-0/MPUCCH_FDD-0" operation="create">
  ...
  <managedObject class="NOKLTE:NTPS" version="FLF18SP_1712_02_1711_04" distName="MRBTS-1/LNBTS-1/FTM-1/IPNO-1/NTPS-1" operation="create">
   <list name = "ntpSyncServers">
   </list>
   <p name="ntpSyncLocalIpMapping">M-Plane</p>
   <p name="ntpSyncPollingRate">16</p>
  </managedObject>
  <managedObject class="com.nokia.srbts.mnl:PMCADM" version="MNL18SP_FZM_1712_002" distName="MRBTS-1/MNL-1/MNLENT-1/PMCADM-1" operation="create">
   <p name="reportingIntervalPm">60min</p>
   <p name="sdlMaxUploadFileNumber">1</p>
   <p name="sdlPrimaryDestIp">0.0.0.0</p>
  </managedObject>
  <managedObject class="NOKLTE:PMCCP" version="FLF18SP_1712_02_1711_04" distName="MRBTS-1/LNBTS-1/PMRNL-1/PMCCP-1" operation="create">
   <p name="cfgFastRRCConnSetReqThresh">1000</p>
   <p name="cfgPRBUtilThreshold">15</p>
   <p name="maxVBreakDistThresh">2</p>
  </managedObject>
  <managedObject class="NOKLTE:PMRNL" version="FLF18SP_1712_02_1711_04" distName="MRBTS-1/LNBTS-1/PMRNL-1" operation="create">
  ...
  <managedObject class="NOKLTE:PMTNL" version="FLF18SP_1712_02_1711_04" distName="MRBTS-1/LNBTS-1/FTM-1/PMTNL-1" operation="create">
  ...
  <managedObject class="NOKLTE:PNASC" version="FLF18SP_1712_02_1711_04" distName="MRBTS-1/LNBTS-1/FTM-1/PNASC-1" operation="create">
  ...
  <managedObject class="NOKLTE:QOS" version="FLF18SP_1712_02_1711_04" distName="MRBTS-1/LNBTS-1/FTM-1/IPNO-1/QOS-1" operation="create">
   <list name = "dscpMap">
    <item>
   <p name="dscp">56</p>
  ...
  <managedObject class="NOKLTE:REDRT" version="FLF18SP_1712_02_1711_04" distName="MRBTS-1/LNBTS-1/LNCEL-0/REDRT-0" operation="create">
  ...
  <managedObject class="NOKLTE:RIM" version="FLF18SP_1712_02_1711_04" distName="MRBTS-1/LNBTS-1/RIM-0" operation="create">
  ...
  <managedObject class="com.nokia.srbts.eqm:RMOD" version="EQM18SP_FZM_1712_002" distName="MRBTS-1/EQM-1/APEQM-1/RMOD-1" operation="create">
   <p name="prodCodePlanned">FWHH_FRHH</p>
  </managedObject>
  <managedObject class="com.nokia.srbts.eqmr:RMOD_R" version="EQMR18SP_FZM_1712_002" distName="MRBTS-1/EQM_R-1/APEQM_R-1/RMOD_R-1" operation="create">
  ...
  <managedObject class="NOKLTE:RTPOL" version="FLF18SP_1712_02_1711_04" distName="MRBTS-1/LNBTS-1/FTM-1/IPNO-1/RTPOL-1" operation="create">
   <list name = "routingPolicies">
   </list>
  </managedObject>
  <managedObject class="NOKLTE:SCTP" version="FLF18SP_1712_02_1711_04" distName="MRBTS-1/LNBTS-1/SCTP-1" operation="create">
  ...
  <managedObject class="NOKLTE:SDRX" version="FLF18SP_1712_02_1711_04" distName="MRBTS-1/LNBTS-1/LNCEL-0/SDRX-0" operation="create">
  ...
  <managedObject class="com.nokia.srbts.mnl:SECADM" version="MNL18SP_FZM_1712_002" distName="MRBTS-1/MNL-1/MNLENT-1/SECADM-1" operation="create">
  ...
  <managedObject class="NOKLTE:SECPRM" version="FLF18SP_1712_02_1711_04" distName="MRBTS-1/LNBTS-1/FTM-1/SECPRM-1" operation="create">
   <p name="idleSessionTimeTwp">45</p>
  </managedObject>
  <managedObject class="NOKLTE:SIB" version="FLF18SP_1712_02_1711_04" distName="MRBTS-1/LNBTS-1/LNCEL-0/SIB-0" operation="create">
   <list name = "celResTiF">
    <item>
  ...
  <managedObject class="com.nokia.srbts.eqm:SMOD" version="EQM18SP_FZM_1712_002" distName="MRBTS-1/EQM-1/APEQM-1/CABINET-1/SMOD-1" operation="create">
   <p name="ledControl">30</p>
   <p name="moduleLocation">AH</p>
   <p name="operatingMode">Normal</p>
   <p name="prodCodePlanned">472946A</p>
  </managedObject>
  <managedObject class="com.nokia.srbts.eqmr:SMOD_R" version="EQMR18SP_FZM_1712_002" distName="MRBTS-1/EQM_R-1/APEQM_R-1/CABINET_R-1/SMOD_R-1" operation="create">
   <p name="configDN">MRBTS-1/EQM-1/APEQM-1/CABINET-1/SMOD-1</p>
   <p name="productCode">472946A</p>
   <p name="productName">FWHH</p>
   <p name="serialNumber">EB164911618</p>
  </managedObject>
  <managedObject class="NOKLTE:STPG" version="FLF18SP_1712_02_1711_04" distName="MRBTS-1/LNBTS-1/FTM-1/SYNC-1/STPG-1" operation="create">
   <list name = "synchroSourceList">
   </list>
   <p name="compClkSync">false</p>
  </managedObject>
  <managedObject class="com.nokia.srbts.mnl:SYNC" version="MNL18SP_FZM_1712_002" distName="MRBTS-1/MNL-1/MNLENT-1/SYNC-1" operation="create">
   <p name="btsSyncMode">FreqSync</p>
   <p name="manualFrameTimingAdjustment">0</p>
  </managedObject>
  <managedObject class="NOKLTE:SYNC" version="FLF18SP_1712_02_1711_04" distName="MRBTS-1/LNBTS-1/FTM-1/SYNC-1" operation="create">
   <p name="actHybridSynch">false</p>
  </managedObject>
  <managedObject class="NOKLTE:TAC" version="FLF18SP_1712_02_1711_04" distName="MRBTS-1/LNBTS-1/FTM-1/TAC-1" operation="create">
  </managedObject>
  <managedObject class="com.nokia.srbts.mnl:TIME" version="MNL18SP_FZM_1712_002" distName="MRBTS-1/MNL-1/MNLENT-1/SYNC-1/TIME-1" operation="create">
   <p name="timeZone">(GMT+5.5) Asia/Calcutta</p>
  </managedObject>
  <managedObject class="NOKLTE:TOPB" version="FLF18SP_1712_02_1711_04" distName="MRBTS-1/LNBTS-1/FTM-1/TOPB-1" operation="create">
   <p name="actTopBoundaryClock">false</p>
  </managedObject>
  <managedObject class="NOKLTE:TOPF" version="FLF18SP_1712_02_1711_04" distName="MRBTS-1/LNBTS-1/FTM-1/TOPB-1/TOPF-1" operation="create">
  ...
  <managedObject class="NOKLTE:TOPP" version="FLF18SP_1712_02_1711_04" distName="MRBTS-1/LNBTS-1/FTM-1/TOPB-1/TOPP-1" operation="create">
   <list name = "acceptedClockQuality">
   <p>6</p>
   <p>7</p>
   </list>
   <list name = "topMasters">
    <item>
   <p name="masterIpAddr">0.0.0.0</p>
    </item>
   </list>
   <p name="actTopPhaseSynch">false</p>
  ...
  <managedObject class="com.nokia.srbts.mnl:TRBLCADM" version="MNL18SP_FZM_1712_002" distName="MRBTS-1/MNL-1/MNLENT-1/TRBLCADM-1" operation="create">
   <p name="actCoreDumpFileCollection">true</p>
   <p name="actRemoteSyslogTransmission">false</p>
  </managedObject>
  <managedObject class="NOKLTE:UNIT" version="FLF18SP_1712_02_1711_04" distName="MRBTS-1/LNBTS-1/FTM-1/UNIT-1" operation="create">
   <p name="unitTypeActual">472946A</p>
   <p name="unitTypeExpected">472946A</p>
  </managedObject>
  <managedObject class="NOKLTE:WIFICNF" version="FLF18SP_1712_02_1711_04" distName="MRBTS-1/LNBTS-1/FTM-1/WIFICNF-1" operation="create">
   <list name = "l2VlanIdList">
   </list>
   <p name="acceptableFrameTypes">ADMIT_ALL</p>
  ...
  <managedObject class="NetworkSoftware" version="" distName="MRBTS-1/NetworkSoftware-1" operation="create">
   <p name="usageState">5</p>
   <p name="versionID">FLF18SP_ENB_9999_180116_000891</p>
  </managedObject>
  <managedObject class="NetworkSoftware" version="" distName="MRBTS-1/NetworkSoftware-2" operation="create">
   <p name="usageState">3</p>
   <p name="versionID">FLF18SP_ENB_9999_180106_000628</p>
  </managedObject>
 </cmData>
</raml>
--==NdasSE2dBYOzlEPEFkEkcXSQAa738auv/CN2KEZ1CBsvPnuJJiuvDvo2Fcmi==
...
Content-Transfer-Encoding: binary
Content-ID: <getFeedback>

<?xml version="1.0" encoding="UTF-8"?>
<NE3SFeedback status = "ok" successful = "1" unsuccessful = "0" version="1.0" xmlns="http://www.nsn.com/schemas/ne3s/feedback/1.0/">
	<message_result>There was "1" successful and "0" unsuccessful operations</message_result>
	<managedObjects>
</managedObjects>
</NE3SFeedback>
--==NdasSE2dBYOzlEPEFkEkcXSQAa738auv/CN2KEZ1CBsvPnuJJiuvDvo2Fcmi==--`
...
var testBody2 = `--==NYWcypeWQfeVATnTH6W/1hXV7Yh15qygqIEv29mNaHpM7Dd7SLbqzBzS7H15==
Content-Type: text/xml; charset=utf-8
Content-Transfer-Encoding: binary
Content-ID: <SOAP-ENV:Envelope>

<?xml version="1.0" encoding="UTF-8"?>
<SOAP-ENV:Envelope xmlns:SOAP-ENV="http://schemas.xmlsoap.org/soap/envelope/" xmlns:SOAP-ENC="http://schemas.xmlsoap.org/soap/encoding/" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:ne3scommon="http://www.nokiasiemens.com/ne3s/1.0"><SOAP-ENV:Header></SOAP-ENV:Header><SOAP-ENV:Body><ne3scommon:getResponse><ne3scommon:agentRegistrationId>123456</ne3scommon:agentRegistrationId><ne3scommon:agentRegistrationKey>s4BxEVlHx+3WuXd/I+okAbnB+N83C69R0Iyz04Dd8u1WluAlsLVvJU5zOcodEfs6AvS3sTS3s0NmmQhBOw96wA==</ne3scommon:agentRegistrationKey><ne3scommon:attachmentProperties><ne3scommon:compression>none</ne3scommon:compression><ne3scommon:contentType>ocos</ne3scommon:contentType><ne3scommon:checksum><ne3scommon:algorithm>none</ne3scommon:algorithm></ne3scommon:checksum></ne3scommon:attachmentProperties><ne3scommon:getResponseContent>cid:getContent</ne3scommon:getResponseContent><ne3scommon:getResponseFeedback>cid:getFeedback</ne3scommon:getResponseFeedback></ne3scommon:getResponse></SOAP-ENV:Body></SOAP-ENV:Envelope>

--==NYWcypeWQfeVATnTH6W/1hXV7Yh15qygqIEv29mNaHpM7Dd7SLbqzBzS7H15==
Content-Type: application/octet-stream
Content-Transfer-Encoding: 7bit
Content-ID: <getContent>
...
<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
<raml version="2.1" xmlns="raml21.xsd">
 <cmData type="plan" scope="hierarchy" id="">
  <header>
   <log action = "get" dateTime="2004-01-01T08:43:02+05:30"></log>
  </header>
  <managedObject class="NOKLTE:ACBPR" version="FLF18SP_1712_02_1711_04" distName="MRBTS-1/LNBTS-1/ACBPR-0" operation="create">
  </managedObject>
  </cmData>
...
var testBody = `--==8xd/xHtnRl8hvOUnbY3Q2fd03Mxh1kX96XGRiZoLLLEM8QeeDLJdTzXtJU9n==
Content-Type: text/xml; charset=utf-8
Content-Transfer-Encoding: binary
Content-ID: <SOAP-ENV:Envelope>

<?xml version="1.0" encoding="UTF-8"?>
<SOAP-ENV:Envelope xmlns:SOAP-ENV="http://schemas.xmlsoap.org/soap/envelope/" xmlns:SOAP-ENC="http://schemas.xmlsoap.org/soap/encoding/" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:ne3scommon="http://www.nokiasiemens.com/ne3s/1.0"><SOAP-ENV:Header></SOAP-ENV:Header><SOAP-ENV:Body><ne3scommon:getResponse><ne3scommon:agentRegistrationId>123456</ne3scommon:agentRegistrationId><ne3scommon:agentRegistrationKey>dvzZ48s1hauJ4jNmw/IY2owz6yZtj1yqT/r24cHJLJrcxbzDVgpy7gDtj9tFGnKLIISAB3UBXMGnEeQIjaJFNw==</ne3scommon:agentRegistrationKey><ne3scommon:attachmentProperties><ne3scommon:compression>none</ne3scommon:compression><ne3scommon:contentType>ocos</ne3scommon:contentType><ne3scommon:checksum><ne3scommon:algorithm>none</ne3scommon:algorithm></ne3scommon:checksum></ne3scommon:attachmentProperties><ne3scommon:getResponseContent>cid:getContent</ne3scommon:getResponseContent><ne3scommon:getResponseFeedback>cid:getFeedback</ne3scommon:getResponseFeedback></ne3scommon:getResponse></SOAP-ENV:Body></SOAP-ENV:Envelope>

--==8xd/xHtnRl8hvOUnbY3Q2fd03Mxh1kX96XGRiZoLLLEM8QeeDLJdTzXtJU9n==
Content-Type: application/octet-stream
Content-Transfer-Encoding: 7bit
Content-ID: <getContent>
...
<raml version="2.1" xmlns="raml21.xsd">
 <cmData type="plan" scope="hierarchy" id="">
  <header>
   <log action = "get" dateTime="2004-01-01T06:50:27+05:30"></log>
  </header>
  <managedObject class="NOKLTE:ACBPR" version="FLF18SP_1712_02_1711_04" distName="MRBTS-1/LNBTS-1/ACBPR-0" operation="create">
  </managedObject>
  <managedObject class="NOKLTE:AMGR" version="FLF18SP_1712_02_1711_04" distName="MRBTS-1/LNBTS-1/FTM-1/AMGR-1" operation="create">
